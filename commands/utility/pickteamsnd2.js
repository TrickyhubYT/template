...
module.exports = {
  ...
  if(message.channel.id === '743881415606796429'){ 
   let role = "743897376007258193"
   let player = '9'
...
message.channel.send(em)
  ...
  */
   ...
   else{ message.channel.send("This command can only be executed in **SND2 Communication**")
}}}
